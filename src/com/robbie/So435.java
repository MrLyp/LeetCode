...
public class So435 {
    public int eraseOverlapIntervals(int[][] intervals) {
        ...
        while (start < intervals.length) {
            if (intervals[start][0] < intervals[last][1]) {
                count++;
                intervals[start][1] = Math.min(intervals[last][1], intervals[start][1]);
            }
            last = start;
            start++;
        }
